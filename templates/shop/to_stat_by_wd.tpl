...
<tr>
	<td class="fcaption2" colspan=4>{VAR:LC_SHOP_TOTAL} {VAR:LC_SHOP_IS} <font color="#ff0000">{VAR:LC_SHOP_GREEN}</font>, {VAR:LC_SHOP_AVERAGE} {VAR:LC_SHOP_IS} <font color="#00ff00">{VAR:LC_SHOP_RED}</font> {VAR:LC_SHOP_NUMB_OF_ORDERS} <font color="#0000ff">{VAR:LC_SHOP_BLUE}</font>.</td>
</tr>
<tr>
