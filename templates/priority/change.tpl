							...
							<tr>
								<td class="tableinside" height="29">
									...
									<table class="aste01" cellpadding=3 cellspacing=1 border=0>
										...
										<tr>
											<td class="celltext">Grupp</td><td class="celltext">Prioriteet</td>
										</tr>
										<!-- SUB: GROUP -->
										<tr>
											<td class="celltext"><select name='grps[{VAR:id}][grp]' class='formselect'><option value=''>{VAR:grps}</select></td><td class="celltext"><input class='formtext' type='text' name='grps[{VAR:id}][pri]' value='{VAR:pri}'></td>
										</tr>
										<!-- END SUB: GROUP -->
									</table>
