							...
							<tr>
								<td class="tableinside" height="29">
									...
									<table class="aste01" cellpadding=3 cellspacing=1 border=0>
										...
										<tr>
											<td class="celltext">Prioriteedi objekt:</td><td class="celltext"><select NAME='priority_id' class="formselect">{VAR:priorities}</select></td>
										</tr>
										<tr>
											<td class="celltext" colspan="2">Vali mis gruppidele millist puud n&auml;idatakse:</td>
										</tr>
										<tr>
											<td class="celltext" >Grupp</td>
											<td class="celltext" >Puu root objekt</td>
										</tr>
										<!-- SUB: GROUP -->
										<tr>
											<td class="celltext">{VAR:grp}</td><td class="celltext"><select NAME='root_ids[{VAR:gid}]' class="formselect">{VAR:roots}</select></td>
										</tr>
										<!-- END SUB: GROUP -->
