...
<tr>
<td class="celltext">T&uuml;&uuml;p:</td><td class="celltext"><select NAME='type' class="formselect">{VAR:type}</select></td>
</tr>
<tr>
<td class="celltext">Template:</td><td class="celltext"><input type='text' NAME='template' class="formtext" VALUE='{VAR:template}'></td>
</tr>
<tr>
