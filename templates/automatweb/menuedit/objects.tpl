...
href="javascript:document.foo.submit()" onClick="return awcopy()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('copy','','{VAR:baseurl}/automatweb/images/blue/awicons/copy_over.gif',1)"><img name="copy" alt="Copy" border="0" SRC="{VAR:baseurl}/automatweb/images/blue/awicons/copy.gif" width="25" height="25"></a>
<!-- SUB: PASTE -->
<IMG SRC="{VAR:baseurl}/images/trans.gif" WIDTH="4" HEIGHT="1" BORDER=0 ALT=""><a href="javascript:document.foo.submit()" onClick="return awpaste()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('paste','','{VAR:baseurl}/automatweb/images/blue/awicons/paste_over.gif',1)"><img name="paste" alt="Paste" border="0" SRC="{VAR:baseurl}/automatweb/images/blue/awicons/paste.gif" width="25" height="25"></a>
<!-- END SUB: PASTE -->
...
<td width="60%" height="15" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=name&order={VAR:order1}&period={VAR:period}'>{VAR:LC_MENUEDIT_NAME}</a>{VAR:sortedimg1}&nbsp;</td>
<td width="4%" align="center" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=jrk&order={VAR:order2}&period={VAR:period}'>{VAR:LC_MENUEDIT_ORDER}</a>{VAR:sortedimg2}&nbsp;</td>
<td width="6%" align="center" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=status&order={VAR:order6}&period={VAR:period}'>{VAR:LC_MENUEDIT_ACTIVE}</a>{VAR:sortedimg6}&nbsp;</td>
<td width="4%" align="center" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=modifiedby&order={VAR:order3}&period={VAR:period}'>{VAR:LC_MENUEDIT_MODIFIED_BY}</a>{VAR:sortedimg3}&nbsp;</td>
<td width="4%" align="center" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=modified&order={VAR:order4}&period={VAR:period}'>{VAR:LC_MENUEDIT_MODIFIED}</a>{VAR:sortedimg4}&nbsp;</td>
<td width="4%" align="center" class="celltext">&nbsp;<a href='orb.{VAR:ext}?class=menuedit&action=obj_list&parent={VAR:parent}&sortby=class_id&order={VAR:order5}&period={VAR:period}'>{VAR:LC_MENUEDIT_TYPE}</a>{VAR:sortedimg5}&nbsp;</td>
