...
<table border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		| Esilehel &uuml;leval: <input type='checkbox' name='frontpage_left' value=1 {VAR:frontpage_left}>
		| Esilehel &uuml;leval jrk: <input type='text' size="2" class="small_button" name='frontpage_left_jrk' value="{VAR:frontpage_left_jrk}">
		| Esilehel all: <input type='checkbox' name='frontpage_right' value=1 {VAR:frontpage_right}>
		| Esilehel all jrk: <input type='text' size="2" name='frontpage_right_jrk' class="small_button" value="{VAR:frontpage_right_jrk}">
		| Paremas paanis: <input type='checkbox' name='frontpage_center' value=1 {VAR:frontpage_center}>
		| Paremas paanis jrk: <input type='text' size="2" name='frontpage_center_jrk' class="small_button"  value="{VAR:frontpage_center_jrk}">
...
<input type="text" name="title" size="80" value="{VAR:title}">
</td>
</tr>
<tr>
<td class="celltext" valign="top"><b>&nbsp;Lead&nbsp;</b></td>
