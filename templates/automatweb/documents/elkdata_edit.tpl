...
<table border=0 cellpadding=0 cellspacing=0>
	...
	| Esilehe uudis: <input type='checkbox' name='frontpage_left' value=1 {VAR:frontpage_left}>&nbsp;Jrk:<input type='text' name='frontpage_left_jrk' size=3 class="small_button" value='{VAR:frontpage_left_jrk}'>
	| Esilehe toode: <input type='checkbox' name='frontpage_center' value=1 {VAR:frontpage_center}>&nbsp;Jrk:<input type='text' name='frontpage_center_jrk' size=3 class="small_button" value='{VAR:frontpage_center_jrk}'>
	| Esilehe teenus: <input type='checkbox' name='frontpage_center_bottom' value=1 {VAR:frontpage_center_bottom}>&nbsp;Jrk:<input type='text' name='frontpage_center_bottom_jrk' size=3 class="small_button" value='{VAR:frontpage_center_bottom_jrk}'>
	| Esilehe kliendile: <input type='checkbox' name='frontpage_right' value=1 {VAR:frontpage_right}>&nbsp;Jrk:<input type='text' name='frontpage_right_jrk' size=3 class="small_button" value='{VAR:frontpage_right_jrk}'>
		</td>
	</tr>
</table>
</td>
