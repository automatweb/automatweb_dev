...
<input class='doc_button' type="submit" value="Eelvaade" onClick="window.location.href='{VAR:preview}';return false;"> <input type="button" class="doc_button" value="Salvesta" onClick="document.doc.submit()"> <input type="submit" class="doc_button" value="Kustuta" name="delete">
