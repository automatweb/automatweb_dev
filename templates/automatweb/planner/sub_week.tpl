...
<td>
	...
	<a href="?class=planner&action=view&id={VAR:hid}&type={VAR:disp}&date={VAR:date}">{VAR:head}</a>
	<br>
	{VAR:dateinfo}
	</td>
	<!-- END SUB: header -->
	...
	<td width="15%" valign="top" bgcolor="{VAR:bgcolor}">
		...
		<b><a href="{VAR:event_link}"><font color="{VAR:color}">{VAR:title}</font></a>{VAR:object}</b>
		<p>
		<!-- END SUB: event -->
		</small>
		&nbsp;
