...
<tr>
<!-- SUB: LISA -->
<td class="ftitle2" colspan="4">Lisa <input type="radio" name="addpos"  value="before" checked class="small_button">enne&nbsp;&nbsp;<input type="radio" name="addpos" value="after" class="small_button">p‰rast valitut</td>
<!-- END SUB: LISA -->
