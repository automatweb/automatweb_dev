...
<tr class="sisu">
	...
	<tr>
		...
		<!-- SUB: re_year_built -->
		{VAR:caption}:<strong>{VAR:value}{VAR:suffix}</strong><br>
		...
		<td>Omandivorm: <strong></strong><br> 
		&Uuml;ldpind: <strong></strong><br>
		Koguhind: <strong>{VAR:transaction_price} kr</strong></td>
	</tr>
	</table>
	<br><br>
	...
	<strong>Info:</strong> {VAR:additional_info} <br><br>
