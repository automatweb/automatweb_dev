...
<!-- SUB: PROP_ERR_MSG -->
<tr>
	<td class="rate_aw04contentcellleft" width="80"></td>
	<td class="rate_aw04contentcellright"><span style="color: red">{VAR:err_msg}</span>	</td>
</tr>
...
<!-- SUB: HEADER -->
<tr>
	<td class="rate_aw04contentcellsubheader" width="80">
	&nbsp;
	</td>
	<td class="rate_aw04contentcellsubheader">
	{VAR:caption}
	</td>
</tr>
<!-- END SUB: HEADER -->
...
<!-- SUB: SUB_TITLE -->
<tr>
	<td colspan="2" class="rate_aw04contentcellsubtitle">
	{VAR:value}
	</td>
</tr>
<!-- END SUB: SUB_TITLE -->
...
<!-- SUB: CONTENT -->
<tr>
	<td colspan="2" class="rate_aw04contentcellcontent" align="center">
	{VAR:value}
	</td>
</tr>
<!-- END SUB: CONTENT -->
...
<!-- SUB: SUBMIT -->
<tr>
	<td class="rate_aw04contentcellleft" align="center" width="80">&nbsp;</td>
	<td class="rate_aw04contentcellright">
