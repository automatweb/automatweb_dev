...
{VAR:profile_change_toolbar}
<!-- SUB: persondata[firstname] -->
<tr>
...
<!-- END SUB: persondata[firstname] -->
<!-- SUB: persondata[lastname] -->
<tr>
