...
<tr>
	<td colspan="2">
		...
		{VAR:LC_RFP_SIGNS}: <strong>{VAR:pointer_text}</strong>
	</td>
</tr>
</table>
...
<table class="data" border="1" width="100%" cellspacing="0" cellpadding="5" bgcolor="#efefef" bordercolor="#ffffff" style="border-collapse: collapse;">
<tr bgcolor="#aaaaaa">
...
<div style="page-break-inside: avoid;">
<table class="contactdata" width="100%" cellspacing="0" cellpadding="5" bgcolor="#efefef" bordercolor="#ffffff" style="border: 1; border-collapse: collapse;">
<tr bgcolor="#aaaaaa">
