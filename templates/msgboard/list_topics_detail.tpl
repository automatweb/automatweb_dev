						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sisuteks" align="center">
							<tr> 
								<td colspan="4" height="14"> 
									<div align="center"><a href="#" class="sisuteks">Mine &uuml;les</a> | 
																			<a href="{VAR:baseurl}/comments.aw?action=addtopic" class="sisuteks">Uus teema</a> | 
																			<a href="{VAR:baseurl}/comments.aw?action=topics" class="sisuteks">N&auml;ita lihtsalt</a> | 
																			<a href="{VAR:baseurl}/comments.{VAR:ext}?action=search" class="sisuteks">Otsi </a> | 
																			<a href="{VAR:baseurl}/comments.{VAR:ext}?action=markallread" class="sisuteks">K&otilde;ik loetuks </a>
									</div>
								</td>
							</tr>
							<tr bgcolor="#CCCCCC"> 
								<td colspan=2>   
									<div align="left"><b>Pealkiri</b></div>
								</td>
								<td> 
									<div align="center"><b> Postitas</b></div>
								</td>
								<td> 
									<div align="center"><b> Postitatud</b></div>
								</td>
							</tr>
							<!-- SUB: TOPIC_EVEN -->
							<tr> 
								...
								<td class="sisuteks" bgcolor="#CCCCCC" valign="top"><a href="comments.aw?section={VAR:topic_id}&msg={VAR:msg_id}" class="sisuteks">{VAR:topic}</a>
									<!-- SUB: NEW -->
										<font color="#990000">uus!</font>
									<!-- END SUB: NEW -->

									<!-- SUB: DELETE -->
										<br><a href="comments.aw?action=delete_topic&id={VAR:topic_id}">Kustuta teema</a>
									<!-- END SUB: DELETE -->
