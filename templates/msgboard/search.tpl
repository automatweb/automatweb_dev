...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="textSmall"><img src="{VAR:baseurl}/img/trans.gif" width="5" height="1" border="0" alt=""><b>{VAR:LC_MSGBOARD_SEARCH_COMM}</b></td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<table align="center" border="0" cellspacing="4" cellpadding="0">
	...
	<tr>
		<td align="right" class="textSmall">{VAR:LC_MSGBOARD_NAME}:&nbsp;<input type='checkbox' value=1 name='s_from'></td>
	...
	<tr>
		<td align="right" valign="top" class="textSmall">{VAR:LC_MSGBOARD_COMMENTARY}:&nbsp;<input type='checkbox' value=1 name='s_comment'></td>
		<td valign="top"><textarea  cols="30" name="comment" rows="8" wrap="virtual"></textarea></td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td align="right"><span class="textSmall">{VAR:LC_MSGBOARD_FROM_ALL_COMM}?&nbsp;</span><input type='checkbox' value=1 name='s_all'>&nbsp;<input type="submit" value="{VAR:LC_MSGBOARD_SEARCH}" class="textSmall"></td>
