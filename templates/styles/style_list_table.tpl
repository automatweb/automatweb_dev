<table hspace=0 vspace=0 cellpadding=3  bgcolor=#a0a0a0>
	<tr>
		...
		<td bgcolor=#f0f0f0><a href='tables.phtml?type=image_list&parent={VAR:parent}'>{VAR:LC_STYLE_IMAGES}</a></td>
...
<table border=0 cellspacing=1 bgcolor=#cccccc cellpadding=2>
	<tr>
		...
		<td class=title colspan=2 align=center>{VAR:LC_STYLE_ACTIVITY}</td>
	</tr>
	<!-- SUB: LINE -->
		<tr>
			<td class=plain >{VAR:style_name}</td>
			<td class=plain><a href='tables.phtml?type=change_style&id={VAR:style_id}&parent={VAR:parent}'>{VAR:LC_STYLE_CHANGE}</a></td>
			<td class=plain><a href='tables.phtml?type=delete_style&id={VAR:style_id}&parent={VAR:parent}'>{VAR:LC_STYLE_DELETE}</a></td>
		</tr>
	<!-- END SUB: LINE -->
	<tr>
		<td class=plain colspan=3 align=center><a href='tables.phtml?type=add_style&parent={VAR:parent}'>{VAR:LC_STYLE_ADD}</a></td>
	</tr>
</table>
