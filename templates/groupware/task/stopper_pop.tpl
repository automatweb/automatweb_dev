...
<!-- END SUB: START -->
 ...
 | <a href='#' onClick='desc=prompt("Kirjeldus", "{VAR:task_name_esc}");if (desc != null) {window.location="{VAR:stop_url}&desc="+desc;}else{return false;}'>{VAR:e_str}</a> | <a href='{VAR:del_url}'>{VAR:d_str}</a><br>
<!-- END SUB: STOPPER -->
