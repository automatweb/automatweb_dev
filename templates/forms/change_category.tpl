...
<tr>
<td class="fcaption">{VAR:LC_FORMS_CREATED}:</td><td class="fform">{VAR:created}, {VAR:createdby}</td>
</tr>
<tr>
<td class="fcaption">{VAR:LC_FORMS_CHANGED}:</td><td class="fform">{VAR:modified}, {VAR:modifiedby}</td>
</tr>
<tr>
