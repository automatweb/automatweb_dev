...
<td bgcolor='#e5e5e5'><a href='{VAR:baseurl}/automatweb/images.{VAR:ext}?type=list&parent={VAR:entry_id}'><font face='tahoma, arial, geneva, helvetica' size="1">{VAR:LC_FORMS_CHANGE_PICTURES}</font></a></td>
</tr>
</table>
