...
<tr>
<td height="15" colspan="15" class="fgtitle">&nbsp;<b>TELLIMUS:</b></td>
</tr>
<tr bgcolor="#C9EFEF">
<td class="title" align=center colspan=2>Tegevus</td>
<!-- SUB: ACTIONS -->
<td class="title" align=center colspan={VAR:colspan}>{VAR:action_name}</td>
<!-- END SUB: ACTIONS -->
</tr>
<tr>
<td class="plain"><a href="javascript:box2('Oled kindel, et soovid seda sisestust kustutada?','forms.{VAR:ext}?type=delete_entry&id={VAR:form_id}&entry_id={VAR:entry_id}&parent={VAR:parent}&op_id={VAR:op_id}')">Kustuta</a></td>
<td class="plain"><a href='forms.{VAR:ext}?type=change_entry&id={VAR:form_id}&entry_id={VAR:entry_id}&parent={VAR:parent}&op_id={VAR:op_id}'>Muuda</a></td>
<!-- SUB: ACTION_LINE -->
