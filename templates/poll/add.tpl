...
<tr>
<td class="fcaption">K&uuml;simus:</td><td class="fform"><input type='text' NAME='name' VALUE='{VAR:name}'></td>
</tr>
<tr>
...
<!-- SUB: QUESTION -->
<tr>
<td class="fcaption">Vastus:</td><td class="fform"><input type='text' NAME='an_{VAR:answer_id}' VALUE='{VAR:answer}'></td>
</tr>
<!-- END SUB: QUESTION -->
<tr>
