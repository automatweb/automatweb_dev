...
<td class="fgtext">&nbsp;<a href='config.{VAR:ext}?type=sel_icon&rtype=other_icon&rid={VAR:mtype}'>Vali ikoon</a>&nbsp;</td>
...
<input type='hidden' name='action' value='export_other_icons'>
</form>
<Br><br>