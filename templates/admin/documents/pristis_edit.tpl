...
<input type="submit" class='doc_button' value="Salvesta"> <input class='doc_button' type="submit" value="Eelvaade" onClick="window.location.href='{VAR:preview}';return false;"> <input type="submit" class='doc_button' value="Sektsioonid" onClick="window.location.href='{VAR:menurl}';return false;"> <input type="submit" class='doc_button' value="Webile" onClick="window.location.href='{VAR:baseurl}/index.{VAR:ext}/section={VAR:id}';return false;"> <input type="submit" class='doc_button' value="Teised keeled" onClick="window.location.href='{VAR:lburl}';return false"> 
</td>
</tr>
<!-- SUB: DOC_BROS -->
<tr>
...
<!-- SUB: IE -->
<tr>
<td class="hele_hall_taust" width=110 valign="top"><img src='{VAR:baseurl}/images/transa.gif' width=110 height=1><Br><B>&nbsp;Pealkiri&nbsp;</b></td>
<td class="hele_hall_taust" width=99%>
...
<tr>
<td class="hele_hall_taust" width=110 valign="top"><b>&nbsp;Lead&nbsp;</b></td>
<td class="hele_hall_taust" width=99%>
...
<tr>
<td class="hele_hall_taust" width=110 valign="top"><b>&nbsp;Sisu&nbsp;</b></td>
<td class="hele_hall_taust" width=99%><iframe onFocus="sel_el='cont_edit'" name="cont_edit" frameborder="1" width="100%" height="400"></iframe>
