...
<form action='{VAR:submit}' method='POST' name='changeform'>
	...
	<table class="form">
		<tr>
			<font color="red"><strong>{VAR:errors}</strong></font>
		...
		<tr class="subheading">
			<th class="sauna" colspan="2">{VAR:LC_ERISOOVID}: <span id="dyn1"><a onclick="$('#dyn2').toggleClass('hidden'); $(this).toggleClass('hidden'); return false;" href="#">{VAR:LC_ERISOOVID_CLICK}</a></span></th>
		</tr>
		<tr>
			<th></th>
			<td class="sauna_bron_textarea">
		...
		<tr>
			...
			<td>
				<img src="{VAR:baseurl}/automatweb/images/pank/hansapank_pay.gif" alt="" />
		...
		<tr>
			...
			<td>
				<img src="{VAR:baseurl}/img/gfx/pank_yhis.gif" alt="" />
			</td>
		</tr>
		<tr>
			<th class="inpt">{VAR:bank_sampopank}</th>
			<td>
				<img src="{VAR:baseurl}/img/gfx/pank_sampo.gif" alt="" />
			</td>
		</tr>
		<tr>
			<th class="inpt">{VAR:bank_nordeapank}</th>
			<td>
				<img src="{VAR:baseurl}/automatweb/images/pank/nordeapank_pay.gif">
			</td>
		</tr>
		<tr>
                        <th class="inpt">{VAR:bank_credit_card}</th>
                        <td>
                                <img src="http://www.estcard.ee/publicweb/graphics/misc/mastercard.gif" alt="" />
                                <img src="http://www.estcard.ee/publicweb/graphics/misc/visaelectron.gif" alt="" />
                        </td>
