	...
	<table class="form">
		...
		<tr>
			...
			<td>
				...
				<option  value="">EE-Hansapank</option>
				<option  value="lv">LV-Hansabanka</option>
				<option  value="lt">LT-Hansabankas</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td>
				<img src="{VAR:baseurl}/automatweb/images/pank/seb_pay.gif" />
			</td>
		</tr>
		<tr>
			<th class="inpt">{VAR:bank_sampopank}</th>
			<td>
				<img src="{VAR:baseurl}/automatweb/images/pank/sampopank_pay.gif" />
			</td>
		</tr>
		<tr>
