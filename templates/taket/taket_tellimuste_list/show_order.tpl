              ...
              <td bgcolor="#B9BED2"><table width="100%"  border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td height="70" valign="middle" bgcolor="#FFFFFF"><table border=0 cellspacing=0 cellpadding=2 width=100% align=center>
                        ...
                        <tr>
                          <td width="19%" class="{VAR:product_codecss}"><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=product_code&dir={VAR:product_codedir}">Tootekood</a></td>
                          <td width="18%" class="{VAR:product_namecss}"><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=product_name&dir={VAR:product_namedir}">Nimetus</a></td>
                          <td width="10%" class="{VAR:pricecss}"><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=price&dir={VAR:pricedir}">Jaehind</a></td>
                          <td width="10%" class="{VAR:discountcss}"><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=discount&dir={VAR:discountdir}">Allah %</a></td>
                          <td width="5%" class="{VAR:finalpricecss}"><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=finalprice&dir={VAR:finalpricedir}">Lõpphind</a></td>
                          <td width="10%" class="{VAR:quantitycss}" colspan=2><a href="?class=taket_tellimuste_list&action=show_order&order_id={VAR:orderId}&sort=quantity&dir={VAR:quantitydir}">Kogus </a></td>
                        </tr>
{VAR:toodeParsed}
<!-- SUB: toode -->
