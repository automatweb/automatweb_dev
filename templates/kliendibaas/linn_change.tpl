									...
									<table class="aste01" cellpadding=3 cellspacing=1 border=0>
										<tr>
											...
											<fieldset><legend>põhiandmed </legend>
												linna nimi <input type=text NAME='linn[name]' value='{VAR:name}' size=25>
												<br>
												asukoht: <input type=text NAME='linn[location]' value='{VAR:location}' size=25>
												<br>
												kommentaarid: <textarea name="linn[comment]" rows=3 cols=40  class="formtext">{VAR:comment}</textarea>
