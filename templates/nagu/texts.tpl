...
<tr>
<td class="fcaption">Tekst:</td><td class="fform">(teksti sees #nimi# asendatakse eelmise v&otilde;itjaga)<br><textarea name="text" cols=40 rows=10>{VAR:text}</textarea></td>
</tr>
<tr>
<td class="fcaption">Vahe tekst:</td><td class="fform"><textarea name="text3" cols=40 rows=10>{VAR:text3}</textarea></td>
</tr>
<tr>
<td class="fcaption">Alumine tekst:</td><td class="fform"><textarea name="text2" cols=40 rows=10>{VAR:text2}</textarea></td>
</tr>
<tr>
