...
<!-- SUB: LINEG -->
<TR>
	<TD class="fcaption">"{VAR:LC_GRAPH_CH_LINE} <b> {VAR:name}</b>" :
</TR>
<TR>
...
<!-- SUB: BARG -->
<TR>
	<TD class="fcaption"> "{VAR:LC_GRAPH_CH_POST}<b> {VAR:name}</b>" :
</TR>
<TR>
	<TD class="fcaption"><SELECT NAME="datasrc">
			<OPTION VALUE=userdata>{VAR:LC_GRAPH_INSERT}</OPTION>
...
<!-- END SUB: BARG -->
<TR>
	<TD class="fcaption">{VAR:LC_GRAPH_Y} <INPUT TYPE="text" NAME="ycount" VALUE="3" SIZE="2">.
</TR>
<TR>
	<TD class="fcaption">{VAR:LC_GRAPH_NOTE}.
</TR>
