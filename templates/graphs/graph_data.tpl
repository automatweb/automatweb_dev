...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<td bgcolor="#CCCCCC"><form method="post" action="reforb.aw" name="data">
	  <table width="100%" border="0" cellspacing=1>
	    <tr>
	      <td class="fcaption2" colspan="5" align="center">{VAR:LC_GRAPH_TABLES} &quot;<B>{VAR:name}</B>&quot; {VAR:LC_GRAPH_SMALL_DATA}</td>
	    </tr>
	    <tr> 
	      <td class="fcaption2" colspan="5"> 
		<p>{VAR:LC_GRAPH_INSERT_DATA_BY_SEP_COMMA} (ntx: X: &quot;Jan,Veb,Mar,...&quot; 
		  Y: &quot;12,12,34,56,...&quot;). {VAR:LC_GRAPH_CANT_INSERT_NEG_VALUES}.</p>
	      </td>
	    </tr>
	    <tr> 
	      <td class="fcaption2" width="10%">X {VAR:LC_GRAPH_SMALL_DATA}</td>
	      <td class="fcaption2" colspan="4" width="76%"> 
		<input type="text" name="arr[x]" size="70" value={VAR:xdata}>
	      </td>
	    </tr>
	<!-- SUB: LINE -->
	    <tr> 
	      <td class="fcaption2" width="10%">Y_{VAR:y_nr} {VAR:LC_GRAPH_SMALL_DATA}</td>
	      <td class="fcaption2"> 
	...
	<tr><td>
		...
		<table border=0 cellspacing=1 cellpadding=2 bgcolor="#CCCCCC">
			<tr><td colspan=2 class="fcaption2" >{VAR:LC_GRAPH_UPLOAD_CSV}:</td></tr>
			<tr>
