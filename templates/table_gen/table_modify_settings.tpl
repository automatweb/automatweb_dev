<table hspace=0 vspace=0 cellpadding=3  bgcolor=#a0a0a0>
	<tr>
		<td bgcolor=#f0f0f0><a href='tables.{VAR:ext}?type=change_table&id={VAR:table_id}'>{VAR:LC_TABLE_EDIT}</a></td>
		<td bgcolor=#a0a0a0><a href='tables.{VAR:ext}?type=settings&id={VAR:table_id}'>{VAR:LC_TABLE_SETTINGS}</a></td>
		<td bgcolor=#f0f0f0><a href='tables.{VAR:ext}?type=change_styles&parent={VAR:table_id}'>{VAR:LC_TABLE_STYLEBOOK}</a></td>
		<td bgcolor=#f0f0f0><a href='tables.{VAR:ext}?type=show_table&id={VAR:table_id}'>{VAR:LC_TABLE_PREVIEW}</a></td>
		<td bgcolor=#f0f0f0><a href='tables.{VAR:ext}?type=image_list&parent={VAR:table_id}'>{VAR:LC_TABLE_IMAGES}</a></td>
		<td bgcolor=#f0f0f0><a href='tables.{VAR:ext}?type=delete_table&id={VAR:table_id}'>{VAR:LC_TABLE_DELETE}</a></td>
	</tr>
</table>
...
<tr>
<td class="fcaption">{VAR:LC_TABLE_NAME}:</td>
...
<tr>
<td class="fcaption">{VAR:LC_TABLE_BACK_COLOR}:</td>
<td class="fform"><input type='text' NAME='bgcolor' VALUE='{VAR:table_bgcolor}'> <a href="#" onclick="varvivalik();">{VAR:LC_TABLE_CHOOSE_COLOR}</a></td>
</tr>
<tr>
<td class="fcaption">{VAR:LC_TABLE_EDGE_WIDTH}:</td>
...
<tr>
<td class="fcaption">{VAR:LC_TABLE_HEIGTH}:</td>
...
<tr>
<td class="fcaption">Default {VAR:LC_TABLE_STYLE_S}:</td>
...
<input type='submit' NAME='save_table_settings' VALUE='{VAR:LC_TABLE_SAVE_TABLE}'>
