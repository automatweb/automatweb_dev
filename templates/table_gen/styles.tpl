...
<tr>
<td bgcolor=#FFFFFF colspan=2>Vali tabeli stiil:</td><td bgcolor="#FFFFFF" colspan=100><select name='table_style'><option value=''>{VAR:tablestyle}</select></td>
</tr>
<tr>
<td colspan=2 bgcolor="#FFFFFF">Vali celli stiil:</td><td bgcolor="#FFFFFF" colspan=100><select name='default_style'><option value=''>{VAR:defaultstyle}</select></td>
</tr>
<tr>
<td bgcolor="#FFFFFF" colspan=2>Mitu celli korraga kustutada:</td><td bgcolor="#FFFFFF" colspan=100><input type='text' name='exp_count' value=1 size=2></td>
</tr>
<tr>
<!-- SUB: DC -->
<td bgcolor="#FFFFFF">
...
<tr>
<!-- SUB: COL -->
<td bgcolor=#FFFFFF rowspan={VAR:rowspan} colspan={VAR:colspan}><b>T:</b> {VAR:text}<br><a class="tablegen_link" href='javascript:pick_style({VAR:row},{VAR:col})'>Vali stiil</a><br>{VAR:EXP_LEFT}&nbsp;{VAR:EXP_UP}&nbsp;{VAR:EXP_RIGHT}&nbsp;{VAR:EXP_DOWN}&nbsp;{VAR:SPLIT_VERTICAL}&nbsp;{VAR:SPLIT_HORIZONTAL}</td>
<!-- END SUB: COL -->
