...
$GLOBALS["TRANS"]["Omaduse Saidi sisene link (url_int_text) kommentaar"] = "avades selle valiku, on võimalik nime või sisu järgi otsida saidi siseseid dokumente, millele link viitama panna.";
$GLOBALS["TRANS"]["Omaduse Saidi sisene link (url_int_text) help"] = "avades selle valiku, on võimalik nime või sisu järgi otsida saidi siseseid dokumente, millele link viitama panna. Olles leidnud sobiva kinnita see \"Vali see\" lingil klikkides. Automaatselt pannakse lingile nimi ning täidetakse URL lahter.";
