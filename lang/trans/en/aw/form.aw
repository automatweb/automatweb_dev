...
$GLOBALS["TRANS"]["No table selected for showing data!"] = "No table selected for showing data!";
$GLOBALS["TRANS"]["Tulemuste kuvamise tabelis pole yhtegi elementi!"] = "No elements in result table!";
$GLOBALS["TRANS"]["form->metainfo(): weird error!"] = "form->metainfo(): weird error!";
?>