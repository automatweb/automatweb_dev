...
$GLOBALS["TRANS"]["Riik valimata"] = "Country not selected";
$GLOBALS["TRANS"]["%s aadressi kasutab seda haldusjaotust! Muudatuste salvestamisel tekivad neis aadressides vead."] = "%s addresses are using this administrative structure! Saving changes will break these addresses.";
?>