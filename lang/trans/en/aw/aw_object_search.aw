...
$GLOBALS["TRANS"]["Omaduse Lisatud kuni (s_crea_to) caption"] = "Created till";
...
$GLOBALS["TRANS"]["Omaduse Muudetud kuni (s_mod_to) caption"] = "Modified till";
$GLOBALS["TRANS"]["Omaduse M&auml;rks&otilde;nad (s_kws) caption"] = "Keywords";
$GLOBALS["TRANS"]["Omaduse Aktiveeri alates (s_tmg_activate_from) caption"] = "Activated from";
$GLOBALS["TRANS"]["Omaduse Aktiveeri kuni (s_tmg_activate_to) caption"] = "Activated till";
$GLOBALS["TRANS"]["Omaduse Deaktiveeri alates (s_tmg_deactivate_from) caption"] = "Deactivated from";
$GLOBALS["TRANS"]["Omaduse Deaktiveeri kuni (s_tmg_deactivate_to) caption"] = "Deactivated till";
