<?php
$GLOBALS["TRANS"]["Omaduse Juurika ID (eralda komadega) (rootnode) caption"] = "Root ID (separate with commas)";
$GLOBALS["TRANS"]["Omaduse Erandite ID (eralda komadega) (exception_node) caption"] = "Exception ID (separate with comma)";
...
$GLOBALS["TRANS"]["Grupi Autoriseerimine (auth) pealkiri"] = "Authorization";
