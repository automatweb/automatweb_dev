...
$GLOBALS["TRANS"]["Viimati minuti jooksul"] = "Last minute";
$GLOBALS["TRANS"]["Viimati 10 minuti jooksul"] = "Last 10 minutes";
$GLOBALS["TRANS"]["Sisse loginud kasutajad"] = "Logged in users";
$GLOBALS["TRANS"]["Logi v&auml;lja"] = "Log out";
$GLOBALS["TRANS"]["Saada teade"] = "Send message";
$GLOBALS["TRANS"]["Suuna"] = "Redirect";
$GLOBALS["TRANS"]["Aadress, kuhu suunata"] = "Address to redirect to";
$GLOBALS["TRANS"]["Kasutaja ip"] = "User IP";
...
$GLOBALS["TRANS"]["Url, mida vaadatakse"] = "Url that the user is viewing";
