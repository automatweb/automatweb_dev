...
$GLOBALS["TRANS"]["Omaduse Filtrite käivitamise intervall (autofilter_delay) caption"] = "Filter activation interval";
...
$GLOBALS["TRANS"][" &nbsp; &nbsp; uid = %s, matches subject rule %s, moving to %s folder<br>"] = " &nbsp; &nbsp; uid = %s, matches subject rule %s, moving to %s folder<br>";
$GLOBALS["TRANS"][" &nbsp; &nbsp; matches from rule %s, moving to %s folder<br>"] = " &nbsp; &nbsp; matches from rule %s, moving to %s folder<br>";
?>