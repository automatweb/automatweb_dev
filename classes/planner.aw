<?php
// $Header: /home/cvs/automatweb_dev/classes/Attic/planner.aw,v 2.188 2004/08/30 12:12:13 sven Exp $
// planner.aw - kalender
...
class planner extends class_base
{
	...
	**/
	...
	function planner($args = array())
	{
		...
		$this->event_toolbar_add_classes = array(CL_TASK,CL_CRM_CALL,CL_CRM_MEETING);
	...
	**/
	...
	function gen_navtoolbar(&$arr)
	{
		$id = $arr["obj_inst"]->id();
			...
			$clidlist = $this->event_toolbar_add_classes;
			$tmp = aw_ini_get("classes");
