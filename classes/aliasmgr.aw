...
// $Header: /home/cvs/automatweb_dev/classes/Attic/aliasmgr.aw,v 2.204 2006/08/07 14:38:19 tarvo Exp $
	...
	**/
	...
	function mk_toolbar($objtype = '', $selectedot = '')
	{
		...
		foreach($this->reltypes as $k => $v)
		{
			...
			if ($dval)
			{
				$dvals = ',"'.html_entity_decode(t("Objekti t&uuml;&uuml;p")).'","capt_new_object"';
