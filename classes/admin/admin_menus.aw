<?php
// $Header: /home/cvs/automatweb_dev/classes/admin/Attic/admin_menus.aw,v 1.48 2002/12/24 15:21:13 kristo Exp $
	...
	function rf_toolbar($args = array())
	{
		...
		foreach($li as $lid => $ln)
		{
			...
			$tmp[] = html::href(array(
				"url" => $url,
				"target" => $target,
				"caption" => ($lid == aw_global_get("lang_id") ? "<b><font color=\"#000000\">".$ln."</font></b>" : $ln)
			));
		}
