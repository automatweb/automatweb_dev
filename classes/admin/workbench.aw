<?php
// $Header: /home/cvs/automatweb_dev/classes/admin/Attic/workbench.aw,v 1.7 2005/12/13 11:43:47 kristo Exp $
	...
	**/
	function gen_folders($arr)
	{
		...
		$this->vars(array(
			...
			"content" => $_GET["NG"] == 1? $afd->gen_folders_new($arr["period"]) : $afd->gen_folders($arr["period"])
		));
