...
@property add_edu_edit type=releditor store=no mode=manager reltype=RELTYPE_ADD_EDUCATION props=org,field,time,time_text,length_hrs,length table_fields=org,field,time,time_text,length_hrs,length group=add_edu
------------------------------------------------------------------
