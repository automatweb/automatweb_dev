<?php
// $Header: /home/cvs/automatweb_dev/classes/interim_page/Attic/interim_page.aw,v 1.1 2006/01/24 13:54:59 markop Exp $
...
class interim_page extends class_base
{
	function interim_page()
	{
		...
		$this->init(array(
			"tpldir" => "interim_page/interim_page",
	...
	function get_property($arr)
	{
		...
		switch($prop["name"])
		{
			case "template":
				...
				$dir = str_replace('automatweb_dev' , 'site' , $dir);
				$template_list = array();
				sort($template_list);
				if(is_dir($dir))
				{
