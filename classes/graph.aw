...
// graph.aw - graafikute haldamine
		...
		$orb_defs["graph"] = array(
			...
			"conf" => array("function" => "configure", "params"=> array("id")),
			"change" => array("function" => "configure", "params"=> array("id")),
			"show" => array("function" => "show", "params"=> array("id")),
			"gotbarline" => array("function" => "line_bar_add", "params"=> array("id","type","name")),
			"savepie" => array("function" => "save_pie"),
			"savelinebar" => array("function" => "line_bar_save"),
			"savedatasrc" => array("function" => "save_datasrc_bar_line", "params"=> array("id","datasrc")),
			"preview" => array("function" => "preview", "params" =>array("id")),
			"userdata" => array("function" => "insert_data", "params" =>array("id")),
			"delete" => array("function" => "delete_graph", "params" =>array("id","parent")),
			"list" => array("function" => "glist", "params" =>array("parent")),
			"save" => array("function" => "save","params"=>array("id")),
			"meta" => array("function" => "show_meta","params"=>array("id")),
			"savedata" => array("function" => "save_userdata","params"=>array("id")),
			"savemeta" => array("function" => "save_meta","params"=>array("id")),
			"upload" => array("function" => "handle_upload",array("id")),
			...
			extract($ar);
				...
				switch ($type) {
					case TYPE_PIE:
						...
						$this->db_query($q);
						return "orb.aw?class=graph&action=conf&id=$id";
