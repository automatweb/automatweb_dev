...
class mail_protector
{
	function protect($str)
	{
		...
		$repl = "<script language=\"javascript\">aw_proteml(\"\\2\",\"\\3\",\"\\6\");</script><noscript>\\2<img src='".aw_ini_get("baseurl")."/automatweb/images/at.png' alt='@' style='vertical-align: middle;'/>\\3</noscript>";
