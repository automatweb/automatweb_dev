<?php
// $Header: /home/cvs/automatweb_dev/classes/applications/realestate_management/realestate_rowhouse.aw,v 1.1 2005/10/31 17:13:35 voldemar Exp $
// realestate_rowhouse.aw - Ridaelamu
/*

HANDLE_MESSAGE_WITH_PARAM(MSG_STORAGE_NEW, CL_REALESTATE_ROWHOUSE, on_create)

@classinfo syslog_type=ST_REALESTATE_ROWHOUSE relationmgr=yes no_comment=1 no_status=1 trans=1
...
@default group=grp_detailed
	...
	@caption Kommunikatsioonid
		...
		@caption Tsentraalne külmaveevarustus
	...
	function get_property($arr)
	{
		...
		switch($prop["name"])
		{
			...
			case "transaction_broker_fee":
				$prop["value"] = number_format ($prop["value"], REALESTATE_NF_DEC, REALESTATE_NF_POINT,
REALESTATE_NF_SEP);
				break;
