<?php
// $Header: /home/cvs/automatweb_dev/classes/applications/scm/scm_competition.aw,v 1.10 2006/08/09 15:06:55 tarvo Exp $
		...
		switch($prop["name"])
		{
			...
			case "contestants":
				...
				foreach($contestants as $oid => $data)
				{
					...
					$t->define_data(array(
						"name" => $person->prop("lastname").", ".$person->prop("firstname"),
