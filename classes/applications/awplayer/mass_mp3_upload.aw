<?php
// $Header: /home/cvs/automatweb_dev/classes/applications/awplayer/Attic/mass_mp3_upload.aw,v 1.3 2007/12/06 14:32:47 kristo Exp $
...
class mass_mp3_upload extends class_base
{
	...
	{
		$this->init(array(
			"tpldir" => "applications/awplayer/mass_mp3_upload",
	...
	function do_import($arr)
	{
		...
		{
			mp3::new_mp3($i_import_parent, $a_keys[$i]);
		}
	}
