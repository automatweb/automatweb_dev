<?php
// $Header: /home/cvs/automatweb_dev/classes/applications/groupware/reservation.aw,v 1.117 2008/07/24 12:09:09 tarvo Exp $
	...
	function set_property($arr = array())
	{
		...
		switch($prop["name"])
		{
			...
			case "end":
				...
				if(!$room_obj->prop("allow_multiple") &&  !$room_inst->check_if_available(array(
