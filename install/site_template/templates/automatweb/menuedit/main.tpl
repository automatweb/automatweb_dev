...
<script type="text/javascript" src="{VAR:baseurl}/css/dhtml.js"></script>
...
<!-- SUB: logged -->
<script type="text/javascript" src="{VAR:baseurl}/css/cssjsmenu.js"></script>
</head>
...
<!--        <td width="1"  class="bgJoon"><img src="{VAR:baseurl}/img/one.gif" width="1" height="1"></td>-->
		...
		<table  width="120" align="center" border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<input type="hidden" name="section" value="{VAR:sel_menu_id}">
			</form>
          <tr>
            <td colspan="2" class="searchLink"><a href="{VAR:baseurl}/?class=search_conf&action=search&section={VAR:section}">T&auml;ppisotsing</a></td>
